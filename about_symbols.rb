...
class AboutSymbols < Neo::Koan
  ...
  def test_method_names_become_symbols
    ...
    all_symbols_as_symbols = Symbol.all_symbols.map { |x| x }

    assert_equal true, all_symbols_as_strings.include?("test_method_names_become_symbols")
    assert_equal true, all_symbols_as_symbols.include?(:test_method_names_become_symbols)
  end
  ...
  # What I'm not sure about is why we convert to strings instead of checking for the symbol
  # I tried both, and both work. So. I guess I'll leave both implemented.
  ...
  ## Symbols can't be garbage collected. At least, not until 2.2 I guess.
end
